...
namespace Properties.Tests.Integration.Tests
{
    public class Test : IClassFixture<ApiFactory>, IAsyncLifetime
    {
        ...
        public async Task GivenValidChangePrice_ChangePrice()
        {
            ...
            // Act
            var responseChancePrice = await _httpClient.PutAsync($"/api/Property/{createdProperty!.PropertyId}/{111}", null);
        ...
        public async Task GivenValidListProperty_ListProperty()
        {
            ...
            // Act
            var responsePropertyList = await _httpClient.GetAsync($"/api/Property/{createdProperty!.PropertyId}/{2010}/{2016}");
            ...
            createdPropertyString!.Count.Should().Be(1);
        }
